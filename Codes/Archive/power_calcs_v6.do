...
Min num of cases per mediator (line 18) - 5,7 or 10
Num of cases in experimental sample (line 19) - 200,300 or 400
Split of mediators in different percentiles (line 63) - 20,30,40 or 50
******************************************************************/
...
_pctile tv, p(50 50) //Change this for different values of p - the values are (p 100-p)
return list
scalar r1=r(r1)
scalar r2=r(r2)
