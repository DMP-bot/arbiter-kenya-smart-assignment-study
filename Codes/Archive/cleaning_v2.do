...
Author: Hamza Syed 
Updated by Didac Marti Pinto to use new data pull (27 Feb 2023)
******************************************************************/
...
local datapull = "05102022" // "05102022" // "27022023" 
...
if "`datapull'" == "27022023" {
	import delimited "`path'\Data\cases_raw_27Feb2023.csv", clear
}
else if "`datapull'" == "05102022" {
	import delimited "`path'\Data\cases_raw_05Oct2022.csv", clear
}
...
//Saving cleaned file
if "`datapull'" == "27022023" {
	save "`path'/Data/cases_cleaned_pull27Feb2023.dta", replace
}
else if "`datapull'" == "05102022" {
	save "`path'/Data/cases_cleaned_pull05Oct2022.dta", replace
}
